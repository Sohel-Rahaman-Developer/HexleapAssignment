      ...
      <div className="absolute h-full w-full bg-[transparent] top-0 left-0 px-[14px] pt-[13px]">
        ...
        <div className="max-w-[200px] mx-auto ">
          <div className="text-center">
            ...
            <button className={`${!isDarkMode ? 'bg-[#1D1D1F] hover:bg-[#000000]' : 'bg-[#000000] hover:bg-[#1D1D1F]'} transition  text-[white] py-[10px] mt-[6px] w-full text-[13px]`}>Take Flight Collection</button>
          </div>
        </div>
      </div>
    </div>
